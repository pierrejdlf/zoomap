...
/*
  mustache.js ‰ÛÓ Logic-less templates in JavaScript
...
;(function(context, MM) {
    ...
    easey_handlers.DoubleClickHandler = function() {
        ...
        function doubleClick(e) {
            ...
            //var point = MM.getMousePoint(e, map);
            z = map.getZoom() + (e.shiftKey ? -0.5 : 0.5);
            
            // use shift-double-click to zoom out
            // poa
            easey().map(map)
                //.to(map.pointCoordinate(MM.getMousePoint(e, map)).zoomTo(z))
                .to(map.pointCoordinate(new MM.Point(map.dimensions.x/2,map.dimensions.y/2)).zoomTo(z))
                //.zoomBy(z)
        ...
        function mouseWheel(e) {
            ...
            if (!ea.running()) {
              ...
              ea.map(map)
                ...
                .to(map.pointCoordinate(new MM.Point(map.dimensions.x/2,map.dimensions.y/2)).zoomTo(z + (delta > 0 ? 0.5 : -0.5)))
